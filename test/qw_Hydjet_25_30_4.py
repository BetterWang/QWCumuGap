...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("hydjet_25-30-fNhsel4.root")
)

process.QWEvent = cms.EDProducer("QWTreeProducer",
		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/25-30/25-30-fNhsel4.root/filetree2")
		)
