...
config.General.requestName = 'HIMB5_ppReco_GMOVtx_Skim_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = False
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_GMOVtx_Skim_v1.py'
...
#########HIMB6
config.General.requestName = 'HIMB6_ppReco_GMOVtx_Skim_v1'
...
########HIMB7
config.General.requestName = 'HIMB7_ppReco_GMOVtx_Skim_v1'
