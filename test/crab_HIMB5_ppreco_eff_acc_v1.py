...
config.General.requestName = 'HIMB5_CumuGap_ppReco_eff_noff_acc_v2'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_eff_acc_v1.py'
...
###### HIMB6
config.General.requestName = 'HIMB6_CumuGap_ppReco_eff_noff_run_acc_v2'
...
######## HIMB7
config.General.requestName = 'HIMB7_CumuGap_ppReco_eff_noff_acc_v2'
