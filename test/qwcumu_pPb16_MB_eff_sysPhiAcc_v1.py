...
process.vectPhiW.srcW = cms.untracked.InputTag('QWPhiWeight')
...
process.ana = cms.Path(process.hltMB*process.eventSelection*process.Noff*process.QWEvent * process.QWPhiWeight * process.cumugap * process.vectMonW)
