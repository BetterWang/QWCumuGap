...
config.General.requestName = 'PAHM0_cumugap_eff_sysWide2_reverse_v5'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM_eff_sysWide2_v1.py'
config.Data.inputDataset = '/PAHighMultiplicity0/PARun2016C-PromptReco-v1/AOD'
config.JobType.inputFiles = ['Hijing_8TeV_MB_Wide2.root']
...
config.General.requestName = 'PAHM1_cumugap_eff_sysWide2_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM1_eff_sysWide2_v1.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_cumugap_eff_sysWide2_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM7_eff_sysWide2_v1.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
