...
process.QWEvent.fweight = cms.untracked.InputTag('Hijing_8TeV_MB_tight4.root')
process.QWEvent.dzdzerror = cms.untracked.double(1.5)
process.QWEvent.d0d0error = cms.untracked.double(1.5)
process.QWEvent.pterrorpt = cms.untracked.double(0.08)
