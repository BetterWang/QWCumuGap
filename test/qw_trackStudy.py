...
process.QWEvent.Etamin = cms.untracked.double(-0.8)
process.QWEvent.Etamax = cms.untracked.double(0.8)
...
process.Vz15 = cms.EDFilter('QWDoubleFilter'
...
process.ana = cms.Path(process.pre_ana*process.primaryVz * process.Vz15 * process.vectMonW)
