...
config.General.requestName = 'PAMB1_cumugap_eff_sysPhiAcc_reverse_v1'
...
config.JobType.inputFiles = ['Hijing_8TeV_MB_Narrow2.root', 'phiMB2_merge.root']
...
##################2
config.General.requestName = 'PAMB2_cumugap_eff_sysPhiAcc_reverse_v1'
...
##################3
config.General.requestName = 'PAMB3_cumugap_eff_sysPhiAcc_reverse_v1'
...
##################4
config.General.requestName = 'PAMB4_cumugap_eff_sysPhiAcc_reverse_v1'
...
##################5
config.General.requestName = 'PAMB5_cumugap_eff_sysPhiAcc_reverse_v1'
...
##################6
config.General.requestName = 'PAMB6_cumugap_eff_sysPhiAcc_reverse_v1'
