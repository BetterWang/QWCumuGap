...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("hydjet_30-35-fNhsel4.root")
)

process.QWEvent = cms.EDProducer("QWTreeProducer",
		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/30-35/30-35-fNhsel4.root/filetree2")
		)
