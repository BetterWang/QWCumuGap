...
#    fileName = cms.string("hydjet_20-25-fNhsel0.root")
#    fileName = cms.string("hydjet_20-25-fNhsel2.root")
    fileName = cms.string("hydjet_20-25-fNhsel4.root")
)

process.QWEvent = cms.EDProducer("QWTreeProducer",
#		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/20-25/20-25-fNhsel0.root/filetree2")
#		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/20-25/20-25-fNhsel2.root/filetree2")
		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/20-25/20-25-fNhsel4.root/filetree2")
		)
