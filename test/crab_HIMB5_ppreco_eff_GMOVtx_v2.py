...
config.General.requestName = 'HIMB5_CumuGap_ppReco_eff_noff_GMOVtx_v6'
...
#########HIMB6
config.General.requestName = 'HIMB6_CumuGap_ppReco_eff_noff_GMOVtx_v6'
...
########HIMB7
config.General.requestName = 'HIMB7_CumuGap_ppReco_eff_noff_GMOVtx_v6'
