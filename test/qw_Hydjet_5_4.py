...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("hydjet_5-10-fNhsel4.root")
)

process.QWEvent = cms.EDProducer("QWTreeProducer",
		pathSrc = cms.untracked.InputTag("/afs/cern.ch/work/e/enazarov/public/HYDJET2_76TeV/converted_files/5-10/5-10-fNhsel4.root/filetree2")
		)
