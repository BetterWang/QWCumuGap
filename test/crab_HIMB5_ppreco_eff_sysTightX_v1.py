...
config.General.requestName = 'HIMB5_CumuGap_ppReco_eff_noff_sysTight3_v2'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_eff_sysTight3_v1.py'
config.JobType.maxJobRuntimeMin = 2500
config.JobType.inputFiles = ['Hydjet_ppReco_tight3_v2.root']
