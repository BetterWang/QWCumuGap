...
config.General.requestName = 'HIMB5_CumuGap_ppReco_eff_noff_GMOVtx_sysPhiAcc_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_eff_GMOVtx_sysPhiAcc_v1.py'
config.JobType.maxJobRuntimeMin = 2500
config.JobType.inputFiles = ['Hydjet_PbPb_eff_v1.root', 'phiPbPb_MB.root']
...
#########HIMB6
config.General.requestName = 'HIMB6_CumuGap_ppReco_eff_noff_GMOVtx_sysPhiAcc_v1'
...
########HIMB7
config.General.requestName = 'HIMB7_CumuGap_ppReco_eff_noff_GMOVtx_sysPhiAcc_v1'
