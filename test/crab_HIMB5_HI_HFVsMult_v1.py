...
config.General.requestName = 'HIMB5_CumuGap_HI_HFVsMult_v2'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_Pix_eff_MultCent_v1.py'
...
####### HIMB6
#config.General.requestName = 'HIMB6_CumuGap_HI_HFVsMult_v2'
...
#
######## HIMB7
#config.General.requestName = 'HIMB7_CumuGap_HI_HFVsMult_v2'
