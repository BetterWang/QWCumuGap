...
process.QWEvent.fweight = cms.untracked.InputTag('Hijing_8TeV_MB_tight2.root')
process.QWEvent.dzdzerror = cms.untracked.double(2.0)
process.QWEvent.d0d0error = cms.untracked.double(2.0)
process.QWEvent.pterrorpt = cms.untracked.double(0.10)
...
process.ana185 = cms.Path(process.hltHM150*process.eventSelection*process.Noff*process.ppNoffFilter185*process.QWEvent*process.cumugap * process.mon185)
process.ana250 = cms.Path(process.hltHM185*process.eventSelection*process.Noff*process.ppNoffFilter250*process.QWEvent*process.cumugap * process.mon250)
