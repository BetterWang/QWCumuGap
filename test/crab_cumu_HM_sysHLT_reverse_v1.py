...
config.General.requestName = 'PAHM0_cumugap_eff_sysHLT_reverse_v5'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM_eff_sysHLT_v1.py'
...
config.General.requestName = 'PAHM1_cumugap_eff_sysHLT_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM1_eff_sysHLT_v1.py'
config.JobType.inputFiles = ['Hijing_8TeV_dataBS.root']
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
