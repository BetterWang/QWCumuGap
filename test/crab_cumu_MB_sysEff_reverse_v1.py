...
config.General.requestName = 'PAMB1_cumugap_eff_sysEff_reverse_v5'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_MB_eff_sysEff_v1.py'
...
## MB2
#config.General.requestName = 'PAMB2_cumugap_eff_v5'
...
#
## MB3
#config.General.requestName = 'PAMB3_cumugap_eff_v5'
...
#
## MB4
#config.General.requestName = 'PAMB4_cumugap_eff_v5'
...
#
## MB5
#config.General.requestName = 'PAMB5_cumugap_eff_v5'
...
#
## MB6
#config.General.requestName = 'PAMB6_cumugap_eff_v5'
