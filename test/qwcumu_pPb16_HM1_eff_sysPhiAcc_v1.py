...
process.cumugap = cms.EDAnalyzer('QWCumuGap'
	...
	, trackWeight = cms.untracked.InputTag('QWPhiWeight')
...
process.QWPhiWeight = cms.EDProducer('QWPhiWeightProducer'
		, src = cms.untracked.InputTag('phiMB2_merge.root')
...
process.vectPhiW120 = process.vectPhiW.clone(srcW = cms.untracked.InputTag('QWPhiWeight'))
process.vectPhiW150 = process.vectPhiW.clone(srcW = cms.untracked.InputTag('QWPhiWeight'))
process.vectPhiW185 = process.vectPhiW.clone(srcW = cms.untracked.InputTag('QWPhiWeight'))
process.vectPhiW250 = process.vectPhiW.clone(srcW = cms.untracked.InputTag('QWPhiWeight'))
...
process.mon120 = cms.Sequence(process.histNoff + process.vectPhi120 + process.vectPt120 + process.vectEta120 + process.vectPhiW120 + process.vectPtW120 + process.vectEtaW120)
process.mon150 = cms.Sequence(process.histNoff + process.vectPhi150 + process.vectPt150 + process.vectEta150 + process.vectPhiW150 + process.vectPtW150 + process.vectEtaW150)
...
process.ana120 = cms.Path(process.hltHM120*process.eventSelection*process.Noff*process.ppNoffFilter120*process.QWEvent * process.QWPhiWeight *process.cumugap * process.mon120)
process.ana150 = cms.Path(process.hltHM150*process.eventSelection*process.Noff*process.ppNoffFilter150*process.QWEvent * process.QWPhiWeight *process.cumugap * process.mon150)
process.ana185 = cms.Path(process.hltHM185*process.eventSelection*process.Noff*process.ppNoffFilter185*process.QWEvent * process.QWPhiWeight *process.cumugap * process.mon185)
process.ana250 = cms.Path(process.hltHM250*process.eventSelection*process.Noff*process.ppNoffFilter250*process.QWEvent * process.QWPhiWeight *process.cumugap * process.mon250)
