...
config.General.requestName = 'PAHM0_cumugap_eff_sysNarrow_reverse_v5'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM_eff_sysNarrow_v1.py'
...
config.General.requestName = 'PAHM1_cumugap_eff_sysNarrow_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM1_eff_sysNarrow_v1.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_cumugap_eff_sysNarrow_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM7_eff_sysNarrow_v1.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
