...
process.QWEvent.fweight = cms.untracked.InputTag('Hijing_8TeV_MB_Wide2.root')
process.cumugap.minvz = cms.untracked.double(3.0)
process.cumugap.maxvz = cms.untracked.double(15.0)
